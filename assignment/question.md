...
Hero: Maya Maged the Warrior
Student ID: 16001120
GitHub account: mayamagedr

A **Sphinx Wraith** bars the way near **the Red Sea coast**. It only falls to
the exact blow.
...
1. Your hero name
2. Your student ID
3. Your power — your student ID **multiplied by 5**
4. Your warcry — copy the line below exactly, including punctuation:

   "By the Red Sea coast, the Sphinx Wraith kneels!"
